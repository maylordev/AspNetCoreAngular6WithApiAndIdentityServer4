...
/* harmony import */ var _core_material_material_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./core/material/material.module */ "./src/app/core/material/material.module.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _pageNotFound_component__WEBPACK_IMPORTED_MODULE_10__["PageNotFoundComponent"],
            ...
            imports: [
                ...
                // Material
                _core_material_material_module__WEBPACK_IMPORTED_MODULE_4__["MaterialModule"],
...
/* harmony import */ var _pageNotFound_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pageNotFound.component */ "./src/app/pageNotFound.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: '**', pathMatch: 'full', component: _pageNotFound_component__WEBPACK_IMPORTED_MODULE_3__["PageNotFoundComponent"] }
];
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                _core__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"],
                _core__WEBPACK_IMPORTED_MODULE_2__["CanDeactivateGuard"],
                _core__WEBPACK_IMPORTED_MODULE_2__["UserProfileService"]
            ]
        })
    ], AppRoutingModule);
...
/***/ "./src/app/core/authGuard.service.ts":
/*!*******************************************!*\
  !*** ./src/app/core/authGuard.service.ts ***!
  \*******************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _userProfile_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userProfile.service */ "./src/app/core/userProfile.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_userProfile_service__WEBPACK_IMPORTED_MODULE_2__["UserProfileService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
/***/ "./src/app/core/canDeactivateGuard.service.ts":
/*!****************************************************!*\
  !*** ./src/app/core/canDeactivateGuard.service.ts ***!
  \****************************************************/
...
var CanDeactivateGuard = /** @class */ (function () {
    ...
    CanDeactivateGuard.prototype.toObservable = function (deactivate) {
        ...
        var o = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["from"])(p);
        return o;
    };
...
/* harmony import */ var _moduleImportCheck__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./moduleImportCheck */ "./src/app/core/moduleImportCheck.ts");
/* harmony import */ var _preload_preload_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./preload/preload.service */ "./src/app/core/preload/preload.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CoreModule = /** @class */ (function () {
    function CoreModule(parentModule) {
        Object(_moduleImportCheck__WEBPACK_IMPORTED_MODULE_4__["throwIfAlreadyLoaded"])(parentModule, 'CoreModule');
    }
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"],
            ],
            exports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"],
            ],
            ...
            providers: [
                ...
                // ExceptionService,
                // MessageService,
                _preload_preload_service__WEBPACK_IMPORTED_MODULE_5__["PreloadService"]
            ]
        }),
...
/***/ "./src/app/core/http/httpClient.service.ts":
/*!*************************************************!*\
  !*** ./src/app/core/http/httpClient.service.ts ***!
  \*************************************************/
...
var HttpClientService = /** @class */ (function () {
    ...
    HttpClientService.prototype.get = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, (Promise.reject(this.normalizeError(error_1)))];
...
/*!*******************************!*\
  !*** ./src/app/core/index.ts ***!
  \*******************************/
/*! exports provided: HttpClientService, AuthGuard, CanDeactivateGuard, PreloadService, UserProfileService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _http_httpClient_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./http/httpClient.service */ "./src/app/core/http/httpClient.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HttpClientService", function() { return _http_httpClient_service__WEBPACK_IMPORTED_MODULE_0__["HttpClientService"]; });

/* harmony import */ var _authGuard_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./authGuard.service */ "./src/app/core/authGuard.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AuthGuard", function() { return _authGuard_service__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]; });

/* harmony import */ var _canDeactivateGuard_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canDeactivateGuard.service */ "./src/app/core/canDeactivateGuard.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CanDeactivateGuard", function() { return _canDeactivateGuard_service__WEBPACK_IMPORTED_MODULE_2__["CanDeactivateGuard"]; });

/* harmony import */ var _preload_preload_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./preload/preload.service */ "./src/app/core/preload/preload.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PreloadService", function() { return _preload_preload_service__WEBPACK_IMPORTED_MODULE_3__["PreloadService"]; });

/* harmony import */ var _userProfile_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./userProfile.service */ "./src/app/core/userProfile.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UserProfileService", function() { return _userProfile_service__WEBPACK_IMPORTED_MODULE_4__["UserProfileService"]; });
...
/***/ "./src/app/core/moduleImportCheck.ts":
/*!*******************************************!*\
  !*** ./src/app/core/moduleImportCheck.ts ***!
  \*******************************************/
...
/***/ "./src/app/core/userProfile.service.ts":
/*!*********************************************!*\
  !*** ./src/app/core/userProfile.service.ts ***!
  \*********************************************/
...
module.exports = __webpack_require__(/*! /Users/maylortaylor/Dropbox/Dev/_Projects/LiveStreamsApp/LiveStreams.Web/ClientApp/src/main.ts */"./src/main.ts");
